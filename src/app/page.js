...
export default function Home() {
  ...
  const siteMetadata = {
    title: "Klinik Kartika - Pusat Layanan Kesehatan Terpercaya",
    description:
      "Klinik Kartika menyediakan layanan kesehatan profesional dengan dokter berpengalaman, fasilitas modern, dan pelayanan prima untuk kesehatan Anda dan keluarga.",
    url: "https://kk-kartika.vercel.app", // ganti dengan domain Anda
    image: "/og-image.jpg", // tambahkan gambar OG
  };
  ...
  const schemaData = {
    ...
    medicalSpecialty: ["General Practice", "Laboratory Testing", "Dental Care"],
    hasOfferCatalog: {
      "@type": "OfferCatalog",
    ...
    staff: doctors.map((doctor) => ({
      "@type": "Physician",
      name: doctor.name,
      medicalSpecialty: doctor.specialty,
      image: `${siteMetadata.url}${doctor.image}`,
    })),
  };
        ...
        >
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <h2
                id="services-heading"
                className="text-3xl md:text-4xl font-bold mt-2 mb-4 text-gray-800 relative inline-block"
              >
                Layanan Kami
                <span
                  className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-24 h-1 bg-pink-500 rounded-full"
                  aria-hidden="true"
                ></span>
              </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {services.map((service) => (
                ...
                >
                  <div className="p-6">
                    <div
                      className="w-14 h-14 bg-green-100 rounded-lg flex items-center justify-center mb-5 text-green-600 group-hover:bg-green-500 group-hover:text-white transition-all duration-300"
                      aria-hidden="true"
                    >
            ...
            <div className="text-center mt-16">
              <Link
                ...
                aria-label="Lihat semua layanan kesehatan yang tersedia"
              >
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="text-center mt-16">
              <Link
                ...
                className="bg-green-500 hover:bg-green-600 text-white font-medium py-3 px-8 rounded-full transition duration-300 shadow-md hover:shadow-lg inline-flex items-center"
                aria-label="Lihat semua dokter yang tersedia"
              >
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <a
                ...
                aria-label="Buat janji temu melalui WhatsApp"
              >
                Buat Janji Temu
              </a>
            </div>
